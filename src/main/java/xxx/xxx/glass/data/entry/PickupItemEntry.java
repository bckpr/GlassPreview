...
public class PickupItemEntry extends Entry {
    ...
    public PickupItemEntry(final BaseEntry baseEntry, final ItemStack item, final int amount) {
    ...
    public PickupItemEntry(final UUID uuid, final User user, final long timestamp, final Position position, final String identifier,
                           final ItemStack item, final int amount) {

        super(uuid, user, Action.PICKUP_ITEM, timestamp, position, identifier);
    ...
    public static class Parser extends ClassParser<PickupItemEntry> {
        ...
        private PickupItemEntry parseDocument(final Document document) {
            ...
            return new PickupItemEntry(baseEntry, item, amount);

        }

        private PickupItemEntry parseResultSet(final ResultSet resultSet) {
